...
import { ChevronRight, Users, Hotel } from "lucide-react";
            ...
            <div 
              ...
              className={cn(
                ...
                { "delay-150": index === 0, "delay-250": index === 1, 
                  "delay-350": index === 2, "delay-450": index === 3, "delay-550": index === 4 }
              )}
            >
                    ...
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <div className="flex items-center text-muted-foreground">
                        ...
                        <span className="text-sm">
                          {room.capacity === 1 ? 'Single Occupancy' : `Fits up to ${room.capacity}`}
                        </span>
                      </div>
                    </div>
                    <div className="mb-4">
